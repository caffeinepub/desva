...
export class Backend implements backendInterface {
    ...
    async getAllProducts(): Promise<Array<[string, Product]>> {
        if (this.processError) {
            try {
    ...
    async submitCustomOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string, arg7: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomOrder(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateContactInfo(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProductPrice(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
