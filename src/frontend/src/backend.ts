...
import type { CustomOrder as _CustomOrder, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCustomOrders(): Promise<Array<CustomOrder>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCustomOrders();
    ...
    async submitCustomOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string, arg7: Array<ExternalBlob>, arg8: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomOrder(arg0, arg1, arg2, arg3, arg4, arg5, arg6, await to_candid_vec_n18(this._uploadFile, this._downloadFile, arg7), arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CustomOrder_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomOrder): Promise<CustomOrder> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CustomOrder>): Promise<Array<CustomOrder>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CustomOrder_n11(_uploadFile, _downloadFile, x)));
}
